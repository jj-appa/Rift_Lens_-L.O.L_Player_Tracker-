// Generated from Riot Data Dragon (patch 16.14.1) champion.json.
// Maps a champion's numeric `championId` (as returned by Match-V5 /
// Champion-Mastery-V4) to its display name.
export const CHAMPION_NAMES: Record<number, string> = Object.fromEntries([
  ...
  [805, "Locke"], [875, "Sett"], [876, "Lillia"], [887, "Gwen"], [888, "Renata Glasc"],
  [893, "Aurora"], [895, "Nilah"], [897, "K'Sante"], [901, "Smolder"], [902, "Milio"],
  [904, "Zaahen"], [910, "Hwei"], [950, "Naafiri"],
]);
